        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative pt-4 pb-12">
            <div className="relative mx-auto w-full max-w-[560px] aspect-[4/3.2] flex items-center justify-center">
              ...
              <div className="relative z-20 w-[340px] sm:w-[420px] transition-transform duration-500 hover:scale-[1.01]">

                {/* Monitor Bezel Frame */}
                <div className="bg-[#0F172A] rounded-2xl p-2.5 sm:p-3 shadow-[0_25px_60px_rgba(15,23,42,0.22)] border-2 border-slate-700/80 relative">

                  {/* Camera Web Sensor */}
                  <div className="w-2 h-2 rounded-full bg-slate-700 mx-auto mb-2" />

                  {/* Desktop Screen Content */}
                  <div className="w-full bg-[#FAFAFC] rounded-xl p-3.5 text-slate-800 border border-slate-200 aspect-[16/10] flex flex-col justify-between overflow-hidden relative shadow-inner">
                    ...
                    <div className="flex items-center justify-between pb-2 border-b border-slate-200 text-[10px]">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 bg-slate-200/70 rounded text-[9px] font-semibold text-slate-600">
                          dashboard.codeai.io
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-3 my-auto items-center">
                      ...
                      <div className="col-span-3 bg-white p-2 rounded-xl border border-slate-200/80 space-y-2 shadow-sm">
                        <div className="w-full h-2.5 bg-purple-600 rounded" />
                      ...
                      <div className="col-span-9 bg-white p-3 rounded-xl border border-slate-200/80 space-y-2.5 shadow-sm">
                        <div className="flex justify-between items-center text-[10px]">
                          <span className="font-bold text-slate-700">Analytics Overview</span>
                          <span className="text-[9px] text-purple-600 font-semibold bg-purple-50 px-2 py-0.5 rounded-full">
                            Live Stream
                          </span>
                        </div>
                        ...
                        {/* Mini Bar Chart Bars */}
                        <div className="flex items-end gap-1.5 h-6 pt-1 border-t border-slate-100">
                    ...
                    <div className="flex items-center justify-between text-[9px] text-slate-400 pt-1 border-t border-slate-200/80">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-12 h-6 bg-gradient-to-b from-slate-400 to-slate-500 rounded-b-md shadow-inner" />
                  <div className="w-36 h-3 bg-gradient-to-r from-slate-300 via-slate-400 to-slate-300 rounded-full shadow-md border-t border-white" />
                </div>
              </div>

              {/* ── Potted Green Plant Next to Monitor ── */}
              <div className="absolute bottom-[40px] right-[4%] z-30 flex items-end">
                <div className="relative group">
                  {/* Leaves SVG */}
                  <div className="w-10 h-12 flex flex-col items-center justify-end">
                    <svg className="w-8 h-8 text-emerald-500 animate-bounce" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12,3 C10,7 6,10 6,14 C6,17.31 8.69,20 12,20 C15.31,20 18,17.31 18,14 C18,10 14,7 12,3 Z" />
                    </svg>
                    <div className="w-7 h-7 bg-slate-200 rounded-b-xl border border-slate-300 shadow-sm" />
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-[2%] left-[-2%] sm:left-[-6%] z-30 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-[0_12px_30px_rgba(99,102,241,0.14)] border border-purple-100 flex flex-col gap-1 w-36 animate-float">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-[10px] font-extrabold text-emerald-500 bg-emerald-50 px-1.5 py-0.5 rounded-full">
                    +22.5%
                  </span>
                </div>
                <div className="w-full h-1 bg-purple-100 rounded-full overflow-hidden mt-1">
                  <div className="w-3/4 h-full bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full" />
                </div>
              </div>

              {/* Card 2: Top Right - Active Users */}
              <div className="absolute top-[10%] right-[-2%] sm:right-[-6%] z-30 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-[0_12px_30px_rgba(99,102,241,0.14)] border border-purple-100 flex items-center gap-3 animate-float-delayed">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-lg font-black text-slate-900 font-display">2,540</span>
                    <span className="text-[9px] font-bold text-emerald-500">+15.3%</span>
                  </div>
                </div>
              </div>

              {/* Card 3: Middle Left - Happy Clients */}
              <div className="absolute bottom-[32%] left-[-4%] sm:left-[-8%] z-30 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-[0_12px_30px_rgba(99,102,241,0.14)] border border-purple-100 flex items-center gap-3 animate-float">
                <div className="w-9 h-9 rounded-xl bg-amber-100 text-amber-600 flex items-center justify-center shrink-0">
                  <Award className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Happy Clients</span>
                  <span className="text-lg font-black text-slate-900 font-display">98% <span className="text-[10px] text-slate-500 font-normal">Satisfaction</span></span>
                </div>
              </div>

              {/* Card 4: Bottom Right - Success Rate */}
              <div className="absolute bottom-[6%] right-[2%] sm:right-[-2%] z-30 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-[0_12px_30px_rgba(99,102,241,0.14)] border border-purple-100 flex items-center gap-3 animate-float-delayed">
                <div className="w-9 h-9 rounded-full border-2 border-purple-600 border-t-orange-400 flex items-center justify-center text-[10px] font-extrabold text-purple-700 bg-purple-50">
                  99.6%
                </div>
                <div>
