...
export const metadata = {
  title: "Disclaimer | Code AI Technology LLC",
  description: "Official disclaimer for Code AI Technology LLC website.",
  alternates: {
    canonical: "https://codeaitechnology.com/disclaimer",
  },
};
      ...
      <div className="bg-white p-8 sm:p-12 rounded-3xl space-y-8 border border-slate-200/90 shadow-md">
        <div className="border-b border-slate-100 pb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-100 text-sky-800 text-xs font-bold uppercase mb-3">
            <FileText className="w-3.5 h-3.5 text-sky-600" /> Legal Information
          </div>
